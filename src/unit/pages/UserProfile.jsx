...
const fetchPredictedGenres = async () => {
  const response = await axios.get(
    `${import.meta.env.VITE_API_BASE_URL}/api/user/predict-favorite-genre`,
    {
      headers: { }, 
      withCredentials: true,  // Important to include cookies
    }
...
const fetchRecentActivity = async () => {
  const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/user/activity`, {
    headers: { },
    withCredentials: true,  // Important to include cookies
  })
...
const fetchUserReviews = async () => {
  const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/user/reviews`, {
    headers: { },
    withCredentials: true,  // Important to include cookies
  })
...
const fetchUserWatchlist = async () => {
  const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/user/watchlist`, {
    headers: { },
    withCredentials: true,  // Important to include cookies
  })
...
function UserProfile() {
  ...
  const updateProfileMutation = useMutation({
    mutationFn: async updatedData => {
          await axios.put(`${import.meta.env.VITE_API_BASE_URL}/api/user/profile`, updatedData, {
        headers: {
  ...
  const removeFromWatchlistMutation = useMutation({
    mutationFn: async movieId => {
          await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/api/user/${movieId}/watchlist`, {
        headers: { },
        withCredentials: true,  // Important to include cookies
      })
    },
